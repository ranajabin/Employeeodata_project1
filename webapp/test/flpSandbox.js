		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeeprjemployeeodataproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeeprjemployeeodataproject-display": {
								"semanticObject": "employeeprjemployeeodataproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeeprj.employeeodataproject",
									"url": sap.ui.require.toUrl("employeeprj/employeeodataproject")
								}
							}
						}
					}
